...
import { ravionaiLogin, OpenAILoginPanel } from './settingsPane'
import { signInravionai, upgraderavionai } from '../features/tools/toolSlice'
            ...
            >
                <div className="errorPopup">
                    ...
                    <div className="errorPopup__body">
                        ...
                        If this continues, please contact michael@ravionai.so.
                        <br />
                    </div>
                </div>
            </Modal>
            ...
            >
                <div className="errorPopup">
                    ...
                    <div className="signup__body">
                        <div className="signup__title">ravionai</div>
                        <div className="signup__module">
                            ...
                            <div
                                ...
                                onClick={() => dispatch(signInravionai(null))}
                            >
                                Log in
                            </div>
            ...
            >
                <div className="errorPopup">
                    ...
                    <div className="signup__body">
                        ...
                        <div className="signup__module">
                            <div className="signup__subtitle">
                                If you've enjoyed using ravionai, please
                                consider subscribing to one of our paid plans
                            </div>
                            <div
                                className="signup__signup_button"
                                onClick={() => dispatch(upgraderavionai(null))}
                            >
                                Upgrade
                            </div>
                        </div>
