                            ...
                            className={`${
                                settings.useOpenAIKey
                                    ...
                                    : 'bg-red-500'
                                            ...
                                            mt-2 relative inline-flex h-[38px] w-[74px] shrink-0 ravionai-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`}
                        >
...
export function ravionaiLogin({
    ...
    const signIn = useCallback(() => {
        dispatch(signInravionai(null))
    }, [])
    const signOut = useCallback(() => {
        dispatch(signOutravionai(null))
    }, [])

    const upgrade = useCallback(() => {
        dispatch(upgraderavionai(null))
    }, [])
    ...
    return (
        <div className="settings__item">
            <div className="settings__item_title">ravionai Account</div>
            <div className="settings__item_description">
