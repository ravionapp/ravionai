...
const auth0Domain = 'ravionai.us.auth0.com'
...
const payUrl = `${HOMEPAGE_ROOT}/pricing?fromravionai=true`
...
export function authPackage() {
    ...
    ipcMain.handle('loginravionai', login)
    ipcMain.handle('signupravionai', signup)
    ipcMain.handle('payravionai', pay)
    ipcMain.handle('settingsravionai', settings)
    ipcMain.handle('logoutravionai', createLogoutWindow)
