...
const addRemoveCallbacks = () => {
    const notificationCallbacks: {
        [language: string]: NotificationCallback
    } = {}
...
const electronConnector = {
    ...
    loginravionai: async () => {
        await ipcRenderer.invoke('loginravionai')
    },
    logoutravionai: async () => {
        await ipcRenderer.invoke('logoutravionai')
    },
    getUserCreds: async () => {
        return await ipcRenderer.invoke('getUserCreds')
    },
    payravionai: async () => {
        return await ipcRenderer.invoke('payravionai')
    },
