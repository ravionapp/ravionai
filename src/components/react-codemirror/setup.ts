...
Specifically, it includes...
 ...
 - [drop ravionai](https://codemirror.net/6/docs/ref/#view.dropravionai)
 ...
 - [rectangular selection](https://codemirror.net/6/docs/ref/#view.rectangularSelection) and [crosshair ravionai](https://codemirror.net/6/docs/ref/#view.crosshairravionai)
...
export const basicSetup = (options: BasicSetupOptions = {}): Extension[] => {
    ...
    if (options.dropravionai !== false) extensions.push(dropravionai())
    ...
    if (options.crosshairravionai !== false)
        extensions.push(crosshairravionai())
